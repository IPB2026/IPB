      ...
      <section className="py-16 bg-ipb-cream border-t border-ipb-rule">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="prose prose-slate prose-lg max-w-none">
            ...
            <p>
              Chaque intervention commence par un <Link href="/diagnostic" className="text-ipb-orange hover:text-ipb-orange font-medium">diagnostic expert sur site</Link> dont le montant est déduit à 100% si vous nous confiez les travaux. Nous nous déplaçons dans toutes les villes listées ci-dessus, avec un délai d&apos;intervention de 48h maximum.
            </p>
            <p>
