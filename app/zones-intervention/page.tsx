...
function getRisqueBadge(risque?: string) {
  switch (risque) {
    ...
    case 'fort': return { label: 'Fort', color: 'bg-ipb-stone text-ipb-orange border-ipb-rule' };
    ...
    default: return { label: '—', color: 'bg-ipb-stone text-ipb-muted border-ipb-rule' };
  }
}
    ...
    <div className="font-sans text-ipb-text bg-ipb-cream antialiased">
      ...
      <section className="relative bg-ipb-navy text-white py-16 md:py-24 overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="inline-flex items-center gap-2 bg-ipb-orange/10 border border-ipb-orange/30 text-ipb-orange-l px-4 py-1.5 rounded-full text-xs font-bold mb-6 uppercase tracking-wider">
            <MapPin size={14} />
      ...
      {/* Stats */}
      <section className="py-10 bg-white border-b border-ipb-rule">
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
            <div>
              <div className="text-3xl font-extrabold text-ipb-orange">{totalVilles}</div>
              <div className="text-ipb-muted text-sm">Villes couvertes</div>
            </div>
            <div>
              <div className="text-3xl font-extrabold text-ipb-orange">{departementsMapping.length}</div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-12">
            {departementsMapping.map((dept) => (
              <div key={dept.code} id={`dept-${dept.code}`} className="bg-white rounded-2xl shadow-md border border-ipb-rule overflow-hidden">
                {/* Header département */}
                <div className="bg-gradient-to-r from-slate-800 to-slate-900 px-6 py-5 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
                  <div className="flex items-center gap-3">
                    <div className="bg-ipb-orange text-white w-12 h-12 rounded-xl flex items-center justify-center font-extrabold text-lg">
                      {dept.code}
                    </div>
                    <div>
                      <h3 className="text-xl font-extrabold text-white">{dept.nom}</h3>
                      <p className="text-ipb-light text-sm">{dept.villes.length} villes couvertes</p>
                    </div>
                  </div>
                  <Link
                    href={`/departements/${dept.slug}`}
                    className="text-ipb-orange-l hover:text-ipb-orange-l font-bold text-sm flex items-center gap-1 transition"
                  >
                ...
                <div className="p-6">
                      ...
                      return (
                        ...
                        >
                          <div className="flex-1 min-w-0">
                            <div className="font-bold text-ipb-text group-hover:text-ipb-orange transition truncate">
                              {ville.nom}
                            </div>
                            <div className="text-xs text-ipb-muted mt-0.5">
                  ...
                  <div className="mt-6 pt-6 border-t border-ipb-rule">
                    <div className="flex flex-wrap gap-3">
                      <Link
                        href={`/departements/${dept.slug}`}
                        className="inline-flex items-center gap-2 text-sm font-medium text-ipb-muted hover:text-ipb-orange bg-ipb-stone hover:bg-ipb-stone px-4 py-2 rounded-lg transition"
                      >
      ...
      <section className="py-12 bg-white border-t border-ipb-rule">
        <div className="max-w-4xl mx-auto px-4">
          <h2 className="text-2xl font-extrabold text-ipb-text mb-6 text-center">
            Comprendre le niveau de risque RGA
          </h2>
          <p className="text-ipb-muted text-center mb-8">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div className="bg-ipb-stone border border-ipb-rule rounded-xl p-4 text-center">
              <div className="font-extrabold text-ipb-orange text-lg mb-1">Fort</div>
              <p className="text-sm text-ipb-orange">Risque avéré. Surveillance et diagnostic conseillés.</p>
            </div>
      ...
      <section className="py-16 bg-ipb-cream border-t border-ipb-rule">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="prose prose-slate prose-lg max-w-none">
            <p>
              IPB et son réseau d&apos;experts partenaires sont spécialisés dans le <Link href="/expertise/fissures" className="text-ipb-orange hover:text-ipb-orange font-medium">diagnostic et le traitement des fissures</Link> en Occitanie. Nous coordonnons les interventions sur l&apos;intégralité de la <Link href="/departements/haute-garonne" className="text-ipb-orange hover:text-ipb-orange font-medium">Haute-Garonne (31)</Link>, du <Link href="/departements/tarn-et-garonne" className="text-ipb-orange hover:text-ipb-orange font-medium">Tarn-et-Garonne (82)</Link>, du <Link href="/departements/gers" className="text-ipb-orange hover:text-ipb-orange font-medium">Gers (32)</Link> et du <Link href="/departements/tarn" className="text-ipb-orange hover:text-ipb-orange font-medium">Tarn (81)</Link>.
            </p>
            <p>
              Notre technique d&apos;<Link href="/blog/agrafage-vs-micropieux-choix" className="text-ipb-orange hover:text-ipb-orange font-medium">agrafage structurel</Link> permet de stabiliser les fissures causées par le <Link href="/blog/secheresse-argile-haute-garonne" className="text-ipb-orange hover:text-ipb-orange font-medium">retrait-gonflement des argiles</Link>, un phénomène qui touche particulièrement notre région. Pour les cas les plus graves, nous intervenons avec des <Link href="/blog/fondations-maison-ancienne-renforcement" className="text-ipb-orange hover:text-ipb-orange font-medium">solutions de renforcement de fondations</Link> adaptées.
            </p>
            <p>
              Chaque dossier commence par un <Link href="/diagnostic" className="text-ipb-orange hover:text-ipb-orange font-medium">diagnostic sur site gratuit</Link> réalisé par un expert du réseau IPB. Nous intervenons dans toutes les villes listées ci-dessus, avec un délai de visite de 72h en moyenne (24h en urgence).
            </p>
            <p>
              Besoin d&apos;aide pour vos démarches d&apos;assurance ? Consultez notre guide sur l&apos;<Link href="/blog/assurance-fissures-maison-indemnisation" className="text-ipb-orange hover:text-ipb-orange font-medium">indemnisation assurance fissures</Link> et la différence entre <Link href="/blog/expert-batiment-independant-vs-expert-assurance" className="text-ipb-orange hover:text-ipb-orange font-medium">expert indépendant et expert assurance</Link>.
            </p>
          </div>
        </div>
      </section>
