      ...
      <section className="py-16 bg-ipb-cream border-t border-ipb-rule">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="prose prose-slate prose-lg max-w-none">
            ...
            <p>
              Chaque dossier commence par un <Link href="/diagnostic" className="text-ipb-orange hover:text-ipb-orange font-medium">diagnostic sur site</Link> réalisé par un expert du réseau IPB. Nous intervenons dans toutes les villes listées ci-dessus, avec un délai de visite de 72h en moyenne (24h en urgence).
            </p>
            <p>
