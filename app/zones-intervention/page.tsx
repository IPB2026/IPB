      ...
      <section className="py-16 bg-slate-50 border-t border-slate-200">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="prose prose-slate prose-lg max-w-none">
            ...
            <p>
              Chaque intervention commence par un <Link href="/diagnostic" className="text-orange-600 hover:text-orange-700 font-medium">diagnostic expert sur site</Link>, prestation déductible des travaux. Nous nous déplaçons dans toutes les villes listées ci-dessus, avec un délai d&apos;intervention de 48h maximum.
            </p>
            <p>
