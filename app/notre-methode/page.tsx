...
export const metadata: Metadata = {
  ...
  description:
    "Les sept étapes de l'institut, du premier contact à la remise du rapport : pré-diagnostic à distance, visite, analyse, calcul avec BET partenaire, rédaction.",
  alternates: {
  ...
  openGraph: {
    ...
    description:
      "Comment l'institut coordonne la lecture d'un bâti, des premiers échanges à la remise du rapport d'inspection. Sept étapes documentées.",
...
const etapes = [
  ...
  },
  {
    ...
    paragraphe:
      "Quand le diagnostic révèle une atteinte structurelle nécessitant un dimensionnement formel (descente de charges, vérification des sections, dimensionnement d'agrafes structurelles, reprise en sous-œuvre par micropieux, pose d'une poutre IPN ou HEB), l'institut mobilise un bureau d'études indépendant. Le calcul s'appuie sur les Eurocodes en vigueur et tient compte des charges permanentes, des charges d'exploitation et des charges climatiques propres au site. Le BET intervient sous sa propre responsabilité civile professionnelle et sa décennale études ; ses notes sont annexées au dossier remis au client.",
    terrain:
  ...
  },
  {
    ...
    paragraphe:
      "Les constats et l'avis technique de l'inspecteur IPB qui a mené la visite sont consignés, puis mis en forme par l'institut après validation par cet inspecteur. Le rapport d'inspection comporte cinq parties fixes : le contexte du dossier, les constats sur site, l'analyse, les préconisations, les annexes (photos, plans, notes de calcul du BET si applicable). La rédaction prend entre une demi-journée et deux jours selon la complexité. Le ton est descriptif, jamais conjectural — quand un point est incertain, le document le dit. Il est livré au format PDF, paginé, avec les photos en pleine résolution.",
    terrain:
      "Le rapport d'inspection fait entre douze et trente-cinq pages. Il documente l'avis technique remis au client à l'issue de la visite. Pour un rapport opposable (vente notariée, dossier assurance, procédure judiciaire), l'institut oriente vers un bureau d'études ou un expert d'assurance indépendant, qui intervient sous sa propre responsabilité.",
  },
  {
    num: '07',
    titre: "La remise et l'accompagnement",
    paragraphe:
      "Le rapport d'inspection vous est remis par email, accompagné d'un appel téléphonique pour en parcourir les points clés. Si vous êtes en compromis, en vente, ou face à un assureur, l'institut peut échanger directement avec votre notaire, votre agent immobilier ou votre interlocuteur d'assurance — avec votre accord. Si le rapport préconise des travaux et que vous décidez de les engager, ils sont exécutés par les entreprises du réseau IPB sous leur garantie décennale 10 ans ; sinon, vous restez libre de consulter d'autres entreprises avec le document en main. L'institut reste disponible pour les questions complémentaires pendant les douze mois qui suivent la remise.",
    terrain:
...
const orientations = [
  {
    ...
    desc: "Avis structurel avant signature ou pendant le délai de rétractation.",
  ...
  },
  {
    ...
    desc: "Un diagnostic avant la mise en vente — vous objectivez l'état du bâti pour vos acheteurs.",
