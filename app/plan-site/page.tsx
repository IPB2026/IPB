...
const sections: Section[] = [
  {
    ...
    links: [
      ...
      { href: '/expertise/retrait-gonflement-argiles', label: 'Retrait-gonflement des argiles (RGA)' },
      { href: '/carte-secheresse-occitanie', label: 'Carte sécheresse Occitanie' },
      { href: '/rdv-cabinet', label: 'Rendez-vous au cabinet' },
      { href: '/partenaires/agences-immobilieres', label: 'Partenaires — agences immobilières' },
      { href: '/expert-humidite/castanet-tolosan', label: 'Humidité à Castanet-Tolosan' },
      { href: '/expert-humidite/fonsorbes', label: 'Humidité à Fonsorbes' },
      { href: '/expert-humidite/lunion', label: 'Humidité à L’Union' },
      { href: '/expert-humidite/plaisance-du-touch', label: 'Humidité à Plaisance-du-Touch' },
      { href: '/expert-humidite/ramonville-saint-agne', label: 'Humidité à Ramonville-Saint-Agne' },
      { href: '/expert-humidite/saint-orens-de-gameville', label: 'Humidité à Saint-Orens-de-Gameville' },
      ...
      { href: '/actualites', label: 'Actualités du bâti' },
      { href: '/actualites/arrete-secheresse-2026', label: 'Arrêté sécheresse 2026' },
      { href: '/actualites/canicule-proteger-maison', label: 'Canicule et fissures' },
      { href: '/actualites/infiltrations-automne-hiver', label: 'Infiltrations automne-hiver' },
