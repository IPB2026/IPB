    ...
    <div className="min-h-screen bg-white">
      ...
      <main id="main-content" className="max-w-6xl mx-auto px-4 py-16">
        <div className="max-w-3xl">
          ...
          <h1 className="text-4xl md:text-5xl font-extrabold text-ipb-text mb-6">{problem.title}</h1>
          <p className="text-lg text-ipb-muted mb-10">{problem.excerpt}</p>
        </div>
        ...
        <section className="grid lg:grid-cols-[1.2fr_0.8fr] gap-12">
          <div className="space-y-8 text-ipb-text leading-relaxed">
            ...
            <div className="bg-ipb-cream border border-ipb-rule rounded-2xl p-6">
              ...
              <ul className="space-y-3 list-disc ml-5 text-ipb-text">
            ...
            <div className="bg-white border border-orange-100 shadow-sm rounded-2xl p-6">
              <h2 className="text-2xl font-bold text-ipb-text mb-3">Notre approche IPB</h2>
              <p>
              ...
              <div className="mt-6 flex flex-col sm:flex-row gap-4">
                <Link
                  ...
                  className="px-6 py-3 rounded-xl bg-ipb-navy text-white font-semibold text-center"
                >
          ...
          <aside className="space-y-6">
            <div className="bg-ipb-navy text-white rounded-2xl p-6">
              ...
              <Link
                href="/contact"
                className="inline-flex items-center justify-center px-5 py-3 rounded-xl bg-ipb-orange text-white font-semibold w-full"
              >
                Parler à un expert
              </Link>
            </div>
            ...
            <div className="bg-ipb-cream border border-ipb-rule rounded-2xl p-6">
              <h3 className="text-lg font-bold text-ipb-text mb-4">Problèmes liés</h3>
              <ul className="space-y-3">
                {relatedProblems.map((item) => (
                  <li key={item.slug}>
                    <Link href={`/problemes/${item.slug}`} className="text-ipb-text hover:text-ipb-orange transition">
                      {item.title}
                    </Link>
                  </li>
                ))}
