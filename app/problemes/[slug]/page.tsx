      ...
      <div className="min-h-screen bg-slate-50">
        ...
        <main className="max-w-5xl mx-auto px-4 py-20">
          ...
          <p className="text-slate-600 mb-8">
            Cette page de diagnostic n’existe pas. Consultez nos expertises ou relancez un diagnostic gratuit.
          </p>
          <div className="flex flex-col sm:flex-row gap-4">
            <Link href="/expertise/fissures" className="px-6 py-3 rounded-xl bg-slate-900 text-white font-semibold">
              Expertise fissures
            </Link>
            <Link href="/expertise/humidite" className="px-6 py-3 rounded-xl border border-slate-300 font-semibold">
              Expertise humidité
            </Link>
          </div>
        </main>
