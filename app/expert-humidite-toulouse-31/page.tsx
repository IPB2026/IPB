      ...
      <section className="py-8 bg-blue-50 border-y border-blue-100">
        <div className="max-w-4xl mx-auto px-4 flex flex-col sm:flex-row items-center justify-center gap-4 text-center">
          ...
          <div className="flex items-center gap-3">
            <Link href="/diagnostic" className="bg-blue-600 hover:bg-blue-700 text-white font-bold px-6 py-2.5 rounded-full text-sm transition-colors whitespace-nowrap">Faire mon pré-diagnostic (2 min) →</Link>
