...
const etapes = [
  ...
  {
    titre: 'Si nécessaire, orientation',
    desc: "Si le rapport préconise des travaux, nous pouvons vous orienter vers des entreprises membres du réseau IPB. Vous gardez la main.",
  },
];
