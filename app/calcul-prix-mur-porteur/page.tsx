...
export const metadata: Metadata = {
  ...
  description: "Estimez votre prix d'ouverture mur porteur Toulouse en 2 min. Gratuit, sans inscription. Tarifs réels IPB. Un seul interlocuteur, du devis à la livraison. ☎ 05 82 95 33 75",
  keywords: [
  ...
  openGraph: {
    ...
    description: "Estimation gratuite en 2 minutes. Tarifs réels IPB. Un seul interlocuteur, du devis à la livraison.",
          ...
          <div className="max-w-4xl mx-auto px-6 lg:px-12">
            <RevealOnScroll>
              ...
              <p className="text-[15px] leading-[1.85] font-light text-ipb-muted mb-8 max-w-2xl">
                Les fourchettes ci-dessous sont calculées à partir de chantiers IPB livrés ces 24 derniers mois. Elles incluent l'étude structure, la pose de la poutre, l'étaiement, l'ouverture et les finitions. <strong className="text-ipb-text not-italic">Décennales métier incluses (études + travaux), un seul interlocuteur de l'étude à la livraison</strong>.
              </p>
