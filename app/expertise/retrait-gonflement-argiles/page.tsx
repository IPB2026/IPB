...
export const metadata: Metadata = {
  title:
    'Retrait-gonflement des argiles · Diagnostic et traitement',
  description:
    "Retrait-gonflement des argiles : mécanisme, signes sur le bâti, protocole de diagnostic, traitements et reconnaissance catastrophe naturelle. Toulouse.",
  alternates: {
    canonical:
          ...
          <div className="max-w-3xl mx-auto px-6 lg:px-12">
            ...
            <RevealOnScroll delay={0.06}>
              <div className="space-y-6 text-[15px] leading-[1.9] font-light text-ipb-text">
                ...
                <p>
                  Le contexte géologique se lit sur la <Link href="/lexique#carte-brgm" className="text-ipb-orange-d underline hover:no-underline">carte BRGM des aléas</Link>, consultable librement sur Géorisques. Nous en tenons une lecture locale à jour dans notre <Link href="/carte-secheresse-occitanie" className="text-ipb-orange-d underline hover:no-underline">relevé des communes d'Occitanie reconnues en catastrophe naturelle sécheresse</Link>. Sur le délai de déclaration ouvert par un arrêté, voir <Link href="/actualites/arrete-secheresse-2026" className="text-ipb-orange-d underline hover:no-underline">notre note sur les arrêtés sécheresse</Link>. Trois niveaux d'aléa sont distingués : faible, moyen, fort. En Haute-Garonne, plus de 70 % du territoire communal est classé en aléa moyen ou fort. La carte ne dit pas qu'un bâti situé en aléa fort connaîtra nécessairement des désordres ; elle dit qu'il y est exposé.
                </p>
                <p>
