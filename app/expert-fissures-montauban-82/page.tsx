...
export const metadata: Metadata = {
  ...
  description: 'Expert fissures maison à Montauban et Tarn-et-Garonne (82). Diagnostic indépendant sous 48h, agrafage structurel garanti 10 ans, garantie décennale. Devis gratuit ☎ 05 82 95 33 75. +200 maisons traitées en Occitanie.',
