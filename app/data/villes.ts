...
export const villesData: Record<string, VilleInfo> = {
  ...
  pamiers: {
    ...
    conseillExpert: "Avant tout achat à Pamiers, exigez un diagnostic du bâti — surtout pour les pavillons sur coteau construits avant 2000.",
    tauxSinistralite: '8,4%'
  },
  foix: {
    nom: 'Foix',
