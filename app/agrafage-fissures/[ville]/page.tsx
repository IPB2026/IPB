...
export async function generateMetadata({ params }: { params: Promise<{ ville: string }> }): Promise<Metadata> {
  ...
  return {
    title: `Agrafage Fissures ${villeNom} ${deptCode} · Rapport 3-5 jours`,
    description: `Agrafage structurel à ${villeNom} : stabilisation des fissures, solution dans 90% des cas. Rapport d'inspection sous 3 à 5 jours. ☎ 05 82 95 33 75`,
    keywords: [
    ...
    openGraph: {
      ...
      description: `Stabilisation par agrafage structurel à ${villeNom}. Rapport d'inspection sous 3 à 5 jours.`,
  ...
  return (
    <>
      ...
      <ServiceVilleTemplate
        ...
        description={`Notre institut prend en charge l'agrafage structurel à ${villeNom} : pose d'aciers inoxydables qui « cousent » la fissure tous les 40 cm pour rendre la maçonnerie monolithique. Solution adaptée à 90 % des fissures de maison individuelle. Rapport d'inspection sous 3 à 5 jours.`}
