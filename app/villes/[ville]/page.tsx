...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  const title = `Expert Fissures & Humidité ${villeData.nom} ${deptCode} · Rapport 3-5 jours`;
  const description = `Expert fissures et humidité à ${villeData.nom} (${villeData.departement}). Visite sous 72h. Rapport d'inspection sous 3 à 5 jours. ☎ 05 82 95 33 75`;
