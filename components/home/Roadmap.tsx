...
const steps = [
  {
    ...
    description: 'On écoute, on analyse votre contexte et on programme l\'intervention sur site.',
  ...
  },
  {
    ...
    description: 'Visite sur site, mesures instrumentées et analyse de l\'existant pour identifier l\'origine exacte du problème.',
  ...
  },
  {
    ...
    description: 'Technique préconisée, chiffrage et planning d\'intervention adaptés à votre situation.',
    detail: 'Devis détaillé sous 72h',
    color: 'cyan',
  },
  {
    number: '04',
    ...
    description: "L'institut coordonne le chantier&nbsp;; les équipes de réalisation du réseau IPB exécutent sous garantie décennale 10 ans. Un seul interlocuteur du début à la fin.",
  ...
  },
  {
    ...
    description: 'Contrôle qualité, vérification des résultats et accompagnement dans vos démarches.',
